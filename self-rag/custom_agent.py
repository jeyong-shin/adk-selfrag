...
class SelfRagAgent(BaseAgent):
    ...
    def __init__(self,
        ...
        super().__init__(
            ...
            relevence_checker=relevence_checker,
    ...
    async def _run_async_impl(self, ctx) -> AsyncGenerator[Event, None]:
        ...
        for _ in range(max_retry):
            ...
            async for event in self.relevence_checker.run_async(ctx):
